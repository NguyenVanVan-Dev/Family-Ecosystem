 ...
 <div class="agileinfo-ads-display col-md-9">
				<div class="wrapper">
					...
					<div class="product-sec1">
                        <h3 class="heading-tittle">Sản Phẩm Tìm Được</h3>
                        <?php
                            use Illuminate\Support\Facades\Session;
                            $mes = Session::get('timsanpham');
                            $mes1 = Session::get('message1');
                            if($mes){
                                echo '  <div class="alert alert-danger">
                                <center>      <strong>Cảnh Báo!</strong> '. $mes.'</center>
                                </div>';  
                            }
                        ?>
                       
						@foreach($timkiem as $key=>$high)
